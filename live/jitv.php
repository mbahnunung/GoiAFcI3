...
<html lang="en">
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# warningfm: http://ogp.me/ns/warningfm#"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <meta property="og:description" content="Klik Gambarnya Boss untuk nonton JITV langsung lewat Facebook." />
    <meta property="og:image" content="https://2.bp.blogspot.com/-fwn_b3QREaU/W-mkKATvTGI/AAAAAAAAKEc/d_nXw4mZPScr5Kh6jKZcTg2Ca1yi1Ab-ACLcBGAs/s1600/logo_jitv.png" />
...
<script type="text/javascript">
    jwplayer("myElement").setup({
        ...
        playlist: [{ 
        title: 'JITV',       
        image: 'https://cdn.jwplayer.com/v2/media/CzGrSEvn/poster.jpg?width=720',       
        sources: [
            {file: 'https://ihon.herokuapp.com/http://202.169.224.76:1935/tv/jitv/playlist.m3u8'},
    ...
    jwplayer().on('play', function(){
        setTimeout(function(){
            ...
            if(textAlt) textAlt.innerHTML = 'JITV';
        },300);
    });
</script>
</div>
