...
<html>
  <head prefix="og:http://ogp.me/ns#">
    <title>DAAITV</title>
    <meta charset="utf-8">
    <meta property="og:url" content="https://content.jwplatform.com/previews/JRtE84Rl-GoiAFcI3">
    <meta property="og:title" content="DAAITV">
    <meta property="og:image" content="https://assets-jpcust.jwpsrv.com/thumbs/JRtE84Rl-720.jpg">
    ...
    <meta name="twitter:player" content="https://content.jwplatform.com/players/JRtE84Rl-GoiAFcI3.html">
    <meta name="twitter:player:width" content="596">
    <meta name="twitter:player:height" content="340">
    <meta name="twitter:player:stream" content="https://content.jwplatform.com/videos/JRtE84Rl-640.mp4">
...
<script type="text/javascript">
    jwplayer("myElement").setup({
        ...
        fallback: false,
        sharing: '',
        skin: {"active": "#00CCCC", "inactive": "#CCCCCC", "name": "six"},
        ...
        playlist: [{ 
        title: 'DAAITV',       
        image: 'https://4.bp.blogspot.com/-uFj1DCmT8Gs/UjlkUjelpeI/AAAAAAAABA0/4xsxfO0UogI/w1200-h630-p-k-no-nu/daai+tv.jpg',       
        sources: [
    ...
    jwplayer().on('play', function(){
        setTimeout(function(){
            ...
            if(textAlt) textAlt.innerHTML = 'DAAITV';
        },300);
    });
</script>
</center>
